...
#ifndef ROVER_CRFS_TELEOP_DOMAIN_LINK_MONITOR_HPP_
#define ROVER_CRFS_TELEOP_DOMAIN_LINK_MONITOR_HPP_
...
{
    // rc/channels older than this means the receiver (or crsf_receiver) has stopped delivering
    // frames. At the launch file's 50 Hz receiver_rate, 200 ms is 10 missed frames.
    ...
    // (or preset) channel values after losing the transmitter; link quality can. Only disable
    // this when crsf_receiver runs with link_stats: false.
