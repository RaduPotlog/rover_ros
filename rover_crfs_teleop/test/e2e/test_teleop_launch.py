...
input. The CRSF receiver is not started - it needs the serial device.
"""
...
NODE_NAME = 'rover_crfs_teleop_node'
...
def generate_test_description():
    config = os.path.join(
        get_package_share_directory('rover_crfs_teleop'), 'config', 'rover_crfs.yaml')
