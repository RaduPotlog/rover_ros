...
TEST_F(RoverGpsNodeTest, ReportsFixDiagnostics)
{
    ...
    ASSERT_TRUE(spinUntil(
        ...
        }, 10s, [this] {publishDrivingNorth(0.0);}));
    ...
    EXPECT_EQ(alignment->level, DiagnosticStatusMsg::OK);
    EXPECT_TRUE(headings_.empty());
}

TEST_F(RoverGpsNodeTest, PublishesHeadingAfterAlignment)
{
    ...
    const double yaw = rover_gps::infrastructure::yawFromQuaternion(
