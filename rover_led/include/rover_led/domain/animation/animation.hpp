...
#ifndef ROVER_LED_DOMAIN_ANIMATION_ANIMATION_HPP_
#define ROVER_LED_DOMAIN_ANIMATION_ANIMATION_HPP_
...
// description is an open, per-plugin property bag, hence YAML::Node.
class Animation
{
...
#endif  // ROVER_LED_DOMAIN_ANIMATION_ANIMATION_HPP_