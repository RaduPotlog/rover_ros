...
#ifndef ROVER_LED_DOMAIN_LED_COMPONENTS_SEGMENT_CONVERTER_HPP_
#define ROVER_LED_DOMAIN_LED_COMPONENTS_SEGMENT_CONVERTER_HPP_
...
#endif  // ROVER_LED_DOMAIN_LED_COMPONENTS_SEGMENT_CONVERTER_HPP_
