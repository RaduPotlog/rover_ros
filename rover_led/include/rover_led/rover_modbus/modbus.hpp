...
#ifndef ROVER_LED_ROVER_MODBUS_ROVER_MODBUS_HPP_
#define ROVER_LED_ROVER_MODBUS_ROVER_MODBUS_HPP_
...
#include "rover_led/rover_modbus/modbus_types.hpp"

#include <rclcpp/rclcpp.hpp>
#include <rclcpp/logging.hpp>

#include "rover_led/rover_modbus/modbus_connection.hpp"
#include "rover_led/rover_modbus/modbus_tcp_connection.hpp"
...
public:
    ...
    void writeMultipleRegisters(const std::vector<uint8_t> &register_values, const uint16_t start_address);
...
#endif  // ROVER_LED_ROVER_MODBUS_ROVER_MODBUS_HPP_