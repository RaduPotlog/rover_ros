...
#ifndef ROVER_CRSF_TELEOP_DOMAIN_STICK_MAPPING_HPP_
#define ROVER_CRSF_TELEOP_DOMAIN_STICK_MAPPING_HPP_

namespace rover_crsf_teleop
{

// Raw CRSF channel range, as produced by the decoder, unscaled (see
// domain/crsf/crsf_protocol.hpp). These are the defaults for the corresponding ROS parameters,
// not hard limits - a transmitter with different endpoints can override them.
...
#endif  // ROVER_CRSF_TELEOP_DOMAIN_STICK_MAPPING_HPP_
