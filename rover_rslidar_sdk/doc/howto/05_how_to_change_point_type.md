...
If `POINT_TYPE` is `XYZI`, rover_rslidar_sdk uses the RoboSense defined type as below. 
...
rover_rslidar_sdk transforms point cloud of `PointXYZI` to ROS message of `PointCloud2`，and publish it.
...
If `POINT_TYPE` is `XYZIRT`, rover_rslidar_sdk uses the RoboSense defined type as below.
...
rover_rslidar_sdk transforms point cloud of `PointXYZIRT` to ROS message of `PointCloud2`，and publish it.
...
If `POINT_TYPE` is `XYZIF`, rover_rslidar_sdk uses the RoboSense defined type as below.
...
rover_rslidar_sdk transforms point cloud of `PointXYZIF` to ROS message of `PointCloud2`，and publish it.
...
If `POINT_TYPE` is `XYZIRTF`, rover_rslidar_sdk uses the RoboSense defined type as below.
...
rover_rslidar_sdk transforms point cloud of `PointXYZIRTF` to ROS message of `PointCloud2`，and publish it.
