...
```
ros2 launch rover_rslidar_sdk humble_start.py
```
...
/rover_rslidar_sdk/src/rover_rslidar_sdk/launch/
├── elequent_start.py
├── humble_start.py
├── humble_Readme.md
├── start.launch
...
After finishing the building of rover_rslidar_sdk
