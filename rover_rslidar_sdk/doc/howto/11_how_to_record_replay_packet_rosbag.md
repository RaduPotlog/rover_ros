...
It is possible to record the point cloud message into a rosbag and replay it, but the point cloud rosbag is very large. rover_rslidar_sdk provides a better way -  record packet rosbag and replay it. 
