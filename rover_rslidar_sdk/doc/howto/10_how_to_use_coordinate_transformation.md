...
rover_rslidar_sdk can transform the coordinate of point cloud. This document illustrate how to do so.
...
rover_rslidar_sdk depends on the libeigen library to do coordinate transformation. Please install it first.
