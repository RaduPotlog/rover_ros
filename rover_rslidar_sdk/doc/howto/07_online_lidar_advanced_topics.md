...
+ with VLAN layer 
+ with user layers. 
+ Also rover_rslidar_sdk supports multi-LiDARs.

This document illustrates how to configure rover_rslidar_sdk in each case.
...
The Lidar sends MSOP/DIFOP packets to the host machine (rover_rslidar_sdk runs on it). For simplicity, the DIFOP port is ommited here.
